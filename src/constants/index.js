import project1 from "../assets/projects/reviewbit.png";
import project2 from "../assets/projects/ayush.png";
import project3 from "../assets/projects/trips.png";
import project4 from "../assets/projects/hex.png";
import project5 from "../assets/projects/socialmedia.png";
...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    company: "HEXEAM SOFTWARE SOLUTIONS GOVT. CYBERPARK - KOZHIKODE",
    description: `Designed and developed user interfaces for web applications using Next.js and React. Worked closely with backend developers to integrate frontend components with Node.js APIs. Implemented responsive designs and optimized frontend performance.`,
    technologies: ["HTML", "CSS", "React js","Redux","Axios"],
  },
  {
    year: "16 March 2022 – 30 June 2022 ",
    role: "Software Engineer",
    company: "CYBAZE TECHNOLOGIES PVT. LTD, UL CYBERPARK - KOZHIKODE ",
    description: `Developed and maintained web applications using JavaScript, React.js, and Node.js. Designed and implemented RESTful APIs for data communication. Collaborated with cross-functional teams to deliver high-quality software products on schedule.`,
    technologies: ["Next Js", "HTML", "CSS","Axios"],
  },
  {
    year: "15 September 2021 to 15 March 2022 ",
    role: "Junior Software Engineer ",
    company: "REVIEWBIT, UL CYBERPARK - KOZHIKODE ",
    description: `Contributed to the development of web applications using JavaScript, React.js, and Node.js. Managed databases and implemented data storage solutions using MongoDB. Worked closely with product managers to prioritize features and enhancements.`,
    technologies: ["CSS", "Polaris Components", "Bootstrap", "Sass"],
  },
];
...
export const PROJECTS = [
  ...
  },
  {
    ...
    image: project2,
    description:
      "Consultation and Wellness Booking, Implement an intuitive and easy-to-use booking system that allows patients to schedule consultations for medical or wellness services with doctors or specialists, Flexible Inquiry System that enable users to make inquiries for appointments,specific practitioners, or treatment type.",
  ...
  },
  {
    ...
    image: project3,
    description:
      "Holiday Package Booking, it Enable users to browse and book complete holiday packages, including accommodations, activities, and transportation in one go also allow user to book a meeting rooms,business spaces at their prreferred hotels or locations.",
  ...
  },
  {
    ...
    image: project5,
    description:
      "A socialmedia platform for creating and publishing blog posts,record video,broadcast,live steaming.",
...
export const CONTACT = {
  address: "Sankaram Ho,Vattoli po,Kakkattil via Vadakara,Kozhikode,kerala,india",
  phoneNo: "+91 8921547425",
  email: "deeshnnasreyas@gmail.com",
};
